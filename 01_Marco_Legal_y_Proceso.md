---
tags: [referencia, guia-completa, licitaciones, México]
---

> 🧭 **Este archivo es una referencia consolidada.** Para el sistema de aprendizaje interconectado, visita el [[🏛️ MOC — Licitaciones Públicas México]].
> **Notas atómicas relacionadas:** [[⚖️ Marco Legal LOPSRM-LAASSP]] · [[🔄 Reforma 2025 — Cambios Clave]] · [[📋 Tipos de Procedimiento de Contratación]] · [[📅 Proceso Cronológico de Licitación]] · [[🔐 Régimen de Garantías]] · [[❌ Causas de Descalificación]] · [[📝 Recurso de Inconformidad]]
...
```mermaid
flowchart TD
    A["1. Planeación y Presupuesto"] --> B["2. Publicación de Convocatoria"]
    B --> C["3. Visita al Sitio"]
    C --> D["4. Junta de Aclaraciones"]
    D --> E["5. Presentación y Apertura de Proposiciones"]
    E --> F["6. Evaluación Técnica y Económica"]
    F --> G["7. Emisión de Fallo"]
    G --> H["8. Formalización del Contrato"]
```
